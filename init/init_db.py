...
'''CREATE TABLE questions (id BIGINT AUTO_INCREMENT, question_text VARCHAR(255), difficulty VARCHAR(255), completed VARCHAR(50), PRIMARY KEY (id));''',
'''INSERT INTO questions (question_text, difficulty, completed) VALUES ("Which movie came out in 1997?", "Easy", "false");''',
'''INSERT INTO questions (question_text, difficulty, completed) VALUES ("Which movie earned the most revenue?", "Easy", "false");''',
'''INSERT INTO questions (question_text, difficulty, completed) VALUES ("How many movies were directed by James Cameron?", "Easy", "false");''',
'''INSERT INTO questions (question_text, difficulty, completed) VALUES ("What is the highest grossing movie that came out before 2000?", "Easy", "false");''',
'''INSERT INTO questions (question_text, difficulty, completed) VALUES ("Which genre has the most movies on this list?", "Medium", "false");''',
